...
//TODO: add overflow page to support varchar's of arbitrary length
//TODO: enforce v.varchar.len <= 64 
    //currently its effectively max_len=std::numeric_limits<uint16_t>
